    ...
    <section className='relative w-[343px] md:w-[260px] mt-4 mx-auto rounded-md border-[0.5px] border-[#FFD66B] bg-[linear-gradient(180deg,#FDF5CB_0%,#FDF5CB_0.01%,#FFF9DB_100%)] p-4 flex flex-col gap-4'>
      ...
      <div className='flex flex-col gap-2'>
        <div className='flex gap-2 items-center'>
          ...
          <div className='truncate w-full text-sm leading-6 font-medium text-[#9D9D9D]'>CODE01CODE01</div>
      ...
      <div className='text-[#C66722] text-sm leading-[18px]  '>Both referrer and referree receives a Blue LiXi when a code being used</div>
    </section>
  )
}